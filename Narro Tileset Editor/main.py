# -*-coding:iso-8859-1 -*
import sys,os,pygame,math,xml.dom.minidom
...
class Appli:
    ...
    def _initialiserTout(self):
        ...
        if len(sys.argv) < 2:
            print("Vous devez fournir un tileset à ouvrir.")
            raise SystemExit
        self.cheminTileset = sys.argv[1]
        ...
        self.image = pygame.image.load(os.path.join(os.path.dirname(self.cheminTileset), self.cheminImage))
